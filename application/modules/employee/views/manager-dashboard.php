<?php $this->load->view('inc/header'); ?>
  ...
  <li class="breadcrumb-item"><a href="<?php echo site_url('employee/student_dashboard'); ?>">Home</a></li>
                              ...
                              ?>
                        <li class="breadcrumb-item active">Manager's Dashboard</li>
                    </ol>
                                ...
                                <div class="card-header">
                                    <div class="media align-items-center">
                                        <div class="media-body">
                                            ...
                                            <!-- <p class="card-subtitle">Birthday list of all employees for <?php echo date('d-m-yy') ; ?></p> -->
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-7">
                            <div class="card">
                                <div class="card-header">
                                    <div class="media align-items-center">
                                        <div class="media-body">
                                            <h4 class="card-title">Employee Reward points</h4>
...
<?php  foreach ($users as $data) { ?>
                                    ...
                                    <li class="list-group-item">
                                        <div class="media align-items-center">
                                            <div class="media-left">
                                                <div class="forum-icon-wrapper">
                                                    <img src="<?php echo base_url(); ?>admin-assets/images/all-users/<?php echo $data->profile_image  ; ?>" alt="" width="40" class="rounded-circle">
                                                </div>
                                            </div>
                                            <div class="media-body">
                                                <a class="text-body" href="<?php echo site_url('employee/profile_view_course/'.$data->id.''); ?>"><strong><?php echo $data->first_name.' ' .$data->last_name ; ?></strong></a><br>
                                                <!-- <div class="d-flex align-items-center">
                                            ...
                                            <div class="media-right text-center d-flex align-items-center">
                                                <h4 class="mb-0"><?php echo $this->employee_m->get_user_rewards_point($data->id); ?></h4>
                                            </div>
                                        </div>
                                    </li>
                            ...
                            <div class="col-lg-7">
                                <div class="card">
                                    <div class="card-header">
                                        <div class="media align-items-center">
                                            <div class="media-body">
                                                <h4 class="card-title">My Reward Points</h4>
                    ...
                    <div class="row">
                        ...
                        <!-- <div class="col-sm-6 col-md-4 col-lg-3">
                            ...
                            <div class="card card--elevated mdk-reveal event-block">
                                ...
                                <img src="<?php echo base_url(); ?>frontend-assets/images/event-4.jpg" alt="">
                                <div class="event-content">
                                    <h5>Nemo enim ipsam voluptatem</h5>
                                    <p><span>Venue:</span>251 San Carlos St, Nokomis, FL, 34275</p>
                                    <p><span>Date:</span>14-02-2020 | 5:00 pm</p>
                                </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3">
                            ...
                            <div class="card card--elevated mdk-reveal event-block">
                                ...
                                <img src="<?php echo base_url(); ?>frontend-assets/images/event-5.jpg" alt="">
                                <div class="event-content">
                                    <h5>Quis autem vel eum iure reprehenderit</h5>
                                    <p><span>Venue:</span>278 S Lincoln St, Minster, OH, 45865</p>
                                    <p><span>Date:</span>26-01-2020 | 11:30 am</p>
                                </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3">
                            ...
                            <div class="card card--elevated mdk-reveal event-block">
                                ...
                                <img src="<?php echo base_url(); ?>frontend-assets/images/event-6.jpg" alt="">
                                <div class="event-content">
                                    <h5>Maxime placeat facere possimus</h5>
                                    <p><span>Venue:</span>251 San Carlos St, Nokomis, FL, 34275</p>
                                    <p><span>Date:</span>14-02-2020 | 5:00 pm</p>
                                </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3">
                            ...
                            <div class="card card--elevated mdk-reveal event-block">
                                ...
                                <img src="<?php echo base_url(); ?>frontend-assets/images/event-7.jpg" alt="">
                                <div class="event-content">
                                    <h5>Nemo enim ipsam voluptatem</h5>
                                    <p><span>Venue:</span>251 San Carlos St, Nokomis, FL, 34275</p>
                                    <p><span>Date:</span>14-02-2020 | 5:00 pm</p>
