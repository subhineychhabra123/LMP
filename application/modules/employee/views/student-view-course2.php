            ...
            <div data-push data-responsive-width="992px" class="mdk-drawer-layout js-mdk-drawer-layout">
                <div class="mdk-drawer-layout__content page ">
                    ...
                    <div class="container-fluid page__container">
                        ...
                        <h1 class="h2">Corporate</h1>
                        <div class="row">
                            <div class="col-md-8">
                                <div class="card">
                                    <div class="embed-responsive embed-responsive-16by9">
                                        <video id="vid"  width="100%" controls>
                                          <source src="http://test.webinch.com/developed/lms/admin-assets/Corporate.mp4" type="video/mp4">
                                    ...
                                    <ul class="list-group list-group-fit">
                                        ...
                                        <li class="list-group-item">
                                            <div class="media align-items-center">
                                                ...
                                                <div class="media-body">
                                                    3 <small class="text-muted">min</small> &nbsp; 28 <small class="text-muted">SEC</small>
                                                </div>
                                                <div class="media-body">
                                ...
                                <ul class="card list-group list-group-fit">
                                    <li class="list-group-item active">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <a href="#" class="text-white">Induction</a>
                                            </div>
