                                        ...
                                        <div class="list-group-item">
                                            <div class="form-group m-0" role="group" aria-labelledby="label-firstname">
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input id="firstname" type="text" placeholder="Your first name" value="Alexander" class="form-control" disabled>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="list-group-item">
                                            <div class="form-group m-0" role="group" aria-labelledby="label-lastname">
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input id="lastname" type="text" placeholder="Your last name" value="Watson" class="form-control" disabled>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div role="group" class="input-group input-group-merge">
                                                            <input id="email" type="email" placeholder="Your email address" value="alexander.watson@gmail.com" class="form-control form-control-prepended" disabled>
                                ...
                                <div data-perfect-scrollbar>
                                    <div class="page-section pt-lg-32pt">
                                        <div class="page-nav__content">
                                            <button class="btn btn-danger" data-toggle="swal" data-swal-title="Password changed successfully" data-swal-text="Click ok to proceed to the next step" data-swal-type="success">
                                                Save Changes
                                            </button>
                                        </div>
                                    </div>
