                ...
                <div class="mdk-drawer-layout__content page ">
                    ...
                    <div class="container-fluid page__container">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Cardiovascular Intro</li>
                        </ol>
                        <h1 class="h2">Cardiovascular Intro</h1>
                        <div class="row">
                            <div class="col-md-8">
                                <div class="card">
                                    <div class="embed-responsive embed-responsive-16by9">
                                        <video id="vid" width="100%" controls>
                                          <source src="http://test.webinch.com/developed/lms/admin-assets/CV-2 WITH DR. RIA.mp4" type="video/mp4">
                                    ...
                                    <ul class="list-group list-group-fit">
                                        ...
                                        <li class="list-group-item">
                                            <div class="media align-items-center">
                                                ...
                                                <div class="media-body">
                                                    24<small class="text-muted">min</small> &nbsp; 06 <small class="text-muted">SEC</small>
                                                </div>
                                                <div class="media-body">
