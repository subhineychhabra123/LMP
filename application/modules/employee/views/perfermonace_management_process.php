<?php $this->load->view('inc/header'); ?>
  ...
  <li class="breadcrumb-item"><a href="<?php echo site_url('employee/student_dashboard'); ?>">Home</a></li>
                    ...
                    <h1 class="h2">Performance management process </h1>

<iframe width="850" height="1000" src="<?php echo base_url('admin-assets/Performance Management Process.pdf'); ?>"></iframe>
