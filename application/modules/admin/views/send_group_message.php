        ...
        <div data-push data-responsive-width="992px" class="mdk-drawer-layout js-mdk-drawer-layout">
            <div class="mdk-drawer-layout__content page ">
                ...
                <div class="container-fluid page__container">
                    ...
                    <form action="<?php  echo site_url('admin/send_group_message') ?>" method="post" >
 ...
 <table class="table   thead-border-top-0 mydataTable text-center">
                                    ...
                                    <?php foreach ($message as $data) { ?>
                                                ...
                                                <tr>
                                                  ...
                                                  <td>
                                                       <a href="<?php  echo site_url('admin/delte_group_message/'.$data->id.'/'.$data->group_id.''); ?>" class="btn btn-sm btn-danger">delete</a> 
                                                    </td>
